...
import {FaUnsplash, FaXTwitter} from "react-icons/fa6";
...
async function getRandomHeroImage() {
    ...
    if (!accessKey || !collectionId) {
        console.warn("Unsplash credentials missing in .env");
    ...
    try {
        const res = await fetch(
            ...
            {
                next: { revalidate: 75 } // Ensure this doesn't exceed Unsplash's rate limit
                // cache: 'no-store'
            }
        );
        ...
        <div className="bento-grid">
            ...
            <div className="col-right">
                <div className="intro-box">
                    <p>Welcome to {siteConfig.author}&#39;s digital garden. Weaving code, sculpting design, and pondering life.</p>
                    <div className="social-row">
                        <Link href="/portfolio" className="btn-projects">Projects</Link>
                        <div className="social-icons">
                            <a href={siteConfig.social.github}><FaGithub size={18} /></a>
                            <a href={siteConfig.social.linkedin}><FaLinkedin size={18} /></a>
                            <a href={siteConfig.social.twitter}><FaXTwitter size={18} /></a>
                        </div>
                    </div>
                </div>
